...
func (*User) Descriptor() ([]byte, []int) { return fileDescriptorAccounts, []int{0} }
...
func (*EmailAddr) Descriptor() ([]byte, []int) { return fileDescriptorAccounts, []int{1} }
...
func (*CreatedAccount) Descriptor() ([]byte, []int) { return fileDescriptorAccounts, []int{2} }
...
func (*NewAccount) Descriptor() ([]byte, []int) { return fileDescriptorAccounts, []int{3} }

func init() {
	proto.RegisterType((*User)(nil), "wfe.User")
	proto.RegisterType((*EmailAddr)(nil), "wfe.EmailAddr")
...
var fileDescriptorAccounts = []byte{
	...
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x63, 0xee, 0xe1, 0xa1, 0x4c, 0x01, 0x00, 0x00,
}
